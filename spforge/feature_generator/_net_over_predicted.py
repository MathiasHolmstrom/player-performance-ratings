...
class NetOverPredictedFeatureGenerator(FeatureGenerator):
    ...
    def __init__(self,
        ...
        _features_out = [net_over_predicted_col, pred_column] if pred_column else [net_over_predicted_col]
    ...
    def fit_transform(self, df: IntoFrameT, column_names: ColumnNames | None = None) -> IntoFrameT:
        transformed = nw.from_native(self.nop_transformer.fit_transform(df, df[self.nop_transformer.target_name]))
