...
from spforge.scorer.score import Filter, apply_filters
...
class Pipeline(BasePredictor):
    ...
    def __init__(
        ...
        self._estimator_features = predictor.features
        ...
        if predictor.features_contain_str:
            logging.info(
                f"Using estimator features {self._estimator_features} and {predictor.features_contain_str}"
            )
        else:
    ...
    def train(self, df: FrameT, features: Optional[list[str]] = None) -> None:
        ...
        features = features or self._estimator_features
