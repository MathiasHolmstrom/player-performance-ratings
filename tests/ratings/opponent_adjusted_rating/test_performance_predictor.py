...
def test_rating_difference_performance_predictor(
    ...
    * team_rating_diff_coef + rating_diff_team_from_entity_coef = rating_diff_coef
    ...
    if (
        player_rating_value > opponent_team_rating_value
        and player_rating_value >= team_rating_value
    ):
    ...
    if (
        player_rating_value == opponent_team_rating_value
        and team_rating_value > player_rating_value
    ):
        assert predicted_performance > 0.5
