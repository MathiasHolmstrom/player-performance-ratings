...
def test_transformer_tuner_regressor(estimator):
    column_weigher_search_range = [
        ParameterSearchRange(
            name='kills',
            type='uniform',
    ...
    transformer_tuner = TransformerTuner(pre_or_post="pre_rating",
                                         transformer_search_ranges=pre_transformer_search_ranges, n_trials=2)
