...
from player_performance_ratings.ratings.match_rating.performance_predictor import RatingDifferencePerformancePredictor, \
    sigmoid_subtract_half_and_multiply2, MODIFIED_RATING_CHANGE_CONSTANT
...
def test_generate_rating_change():
    ...
    expected_player2_rating_change_value = (pre_match_team_ratings[0].players[
                                                1].match_performance.performance_value - expected_player1_predicted_performance) * \
                                           expected_rating_change_multiplier

    expected_rating_change = TeamRatingChange(
        id="1",
        league=None,
        performance=1 * 0.5 + 0.8 * 0.3,
        ...
        predicted_performance=(
                                      ...
                                      0.5 + 0.3),
        rating_change_value= expected_player2_rating_change_value * 0.3 + expected_player1_rating_change_value * 0.5,
        players=[
            PlayerRatingChange(
                id="1",
                day_number=1,
