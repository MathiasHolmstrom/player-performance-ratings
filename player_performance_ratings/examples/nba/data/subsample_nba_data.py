...
df = df.merge(gt[['game_id', 'team_id', "team_id_opponent", 'score', 'score_opponent', 'won']],
...
df = df[["team_id", "start_date", "game_id", "player_id", "team_id_opponent", "points", "minutes", "won"]]
